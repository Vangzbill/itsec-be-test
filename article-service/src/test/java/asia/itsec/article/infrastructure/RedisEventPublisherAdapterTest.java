...
class RedisEventPublisherAdapterTest {
    ...
    void publish_sendsSerializedEventToAuditChannel() {
        ...
        AuditEvent event = AuditEvent.builder()
                .actorId("author-1").action("ARTICLE_CREATED").entityType("ARTICLE").entityId("article-1")
        ...
        assertThat(payloadCaptor.getValue()).contains("ARTICLE_CREATED").contains("article-1");
    }
}
